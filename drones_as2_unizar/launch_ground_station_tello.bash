...
if [ -z "$drones_namespace_comma" ]; then
  drones_namespace_comma=$(python3 utils/get_drones.py -p config/tello/config.yaml --sep ',')
fi
...
eval "tmuxinator ${tmuxinator_mode} -n ground_station -p tmuxinator/tello/ground_station.yaml \
